...
\noindent{clear the features from the existing ForfeitureParcels dataset}
\vspace{.25in}
...
\clearpage
  %
  %
\paragraph*{Table is added to the map}
  %
  % Single Figure No Wrap
  %
\begin{figure}[h!]
...
\clearpage
  %
  %
\subparagraph*{\Large push \fbox{Next}}
  %
  % Single Figure No Wrap
  %
\begin{figure}[h!]
...
\noindent Press \Large \fbox{Continue}
\vspace{2in}

\noindent Enter Credentials
\vspace{1in}

\noindent Press \Large \fbox{SIGN IN}
...
\noindent {\large \fbox{Press Download}}
...
\noindent{\LARGE\fbox{Notes} \lookArrow}
\vspace{2.6in}
...
\noindent{\LARGE\fbox{Comments} \lookArrow}
\vspace{3in}
...
\noindent{\LARGE\fbox{Check Mark} \lookArrow}
  %
\clearpage
  %
  %
...
\noindent{\normalsize\fbox{2.Reconcile Versions and Compress}} {\LARGE\lookArrow}
