...
\noindent{\smallbtn If date has been updated then map is now synchronized}
 ...
 \begin{wrapfigure}{r}{0.6\textwidth}
 \centering
     \includegraphics[width=.45\textwidth]{printToday.png}
 \caption {Print Today}
 \vspace{.05in}
 ...
 \vspace{.05in}
     ...
     \includegraphics[width=.45\textwidth]{inspectionDate.png}
 \caption{Enter Date}
...
\clearpage
 ...
 \begin{wrapfigure}{r}{0.6\textwidth}
 \centering
     \includegraphics[width=.4\textwidth]{status.png}
 ...
 \vspace{.05in}
     ...
     \includegraphics[width=.4\textwidth]{statusNotes.png}
 \caption{Enter Text}
 \end{wrapfigure}
 ...
 \begin{wrapfigure}{r}{0.6\textwidth}
 \centering
     \includegraphics[width=.4\textwidth]{propertyForSale.png}
 \caption{Yes or No}
  \vspace{.05in}
...
\includegraphics[width=.4\textwidth]{forfPosted.png} %Forfeiture Posted
 ...
 \noindent{\btn\fbox{Property For Sale} \lookArrow}
 \vspace{4in} 
...
%   %
 ...
 \begin{wrapfigure}{r}{0.6\textwidth}
 \centering
     \includegraphics[width=.4\textwidth]{selectParcel.png}
 ...
 \vspace{.1in}
     ...
     \includegraphics[width=.4\textwidth]{addAttachment.png}
...
\noindent {\Large Next is exporting reports for the sites visited}
...
Any parcel that is marked {\bigbtn\fbox{Print Today}} as {\bigbtn\fbox{Yes}} will generate a report.\\ 
...
\centering
     \includegraphics[width=.45\textwidth]{PostprocessingTool2.png}
