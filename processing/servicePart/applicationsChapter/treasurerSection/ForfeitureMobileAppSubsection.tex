...
%\paragraph[Overview]{Overview} {\color{graphicOrange}{\Huge\textbf{Forfeiture Parcels}}}\\
%is used through the workflow
\paragraph[Overview]{Overview}
%{\color{graphicOrange}{\Huge\textbf{Forfeiture Parcels}}}\\
%is used through the workflow
%\vspace{.20in}
...
%\noindent Enter road used for access
\vspace{2.5in}
