...
\clearpage
 ...
 \end{figure}
 \item choose location and press \fbox{OK}
 \end{itemize}
 \clearpage
   %
   %
...
In Catalog \rtArrow Right click on ACpub \rtArrow Administration \rtArrow Add User
 ...
 \noindent Press \Large \fbox{Continue} \lookArrow
 \vspace{2.75in}

 \noindent Enter Credentials
 \vspace{1in}

 \noindent Press \Large \fbox{SIGN IN} \lookArrow
 ...
 \noindent {\large \fbox{Press Download} \lookArrow}
 ...
 \noindent Press \fbox{Download} \lookArrow
 \vspace{3.5in}
