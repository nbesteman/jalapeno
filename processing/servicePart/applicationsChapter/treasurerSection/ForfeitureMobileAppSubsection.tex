...
\IfStandalone{\subsection{Forfeiture Data Collection}}{\subsection[Forfeiture Data Collector][Forfeiture Data Collection Application]{Forfeiture Data Collection}}
...
%
%
%\subparagraph[Add Query Layer]{}
{\LARGE Add Query Layer}
\vspace{.25in}
...
%
%
{\LARGE Details of the Query Layer}
\vspace{.25in}

{\Large Enter into the tool}
\begin{itemize}
...
%
%
{\LARGE Select a Unique Identifier}
\vspace{.25in}
...
%
%
{\LARGE Table is added to the map}
\vspace{.25in}
...
%
%
{\LARGE Add Parcels Layer to the map}
\vspace{.25in}
...
Create new join to ACParcelsCombined of forfeitures based on parcel numbers
\vspace{.25in}
...
%
%
{\LARGE Export Joined Features to a temp location}
\vspace{.25in}
...
%
%
\subparagraph[Match these fields]{\Large Match these fields}
\subparagraph*{}
%
% Single Figure No Wrap
%
\begin{figure}[h!]
\centering
    \includegraphics[width=.5\textwidth]{fieldMatch1.PNG}
\caption{Match Fields}
\end{figure}
\begin{figure}[h!]
\centering
    \includegraphics[width=.5\textwidth]{fieldMatch2.PNG}
\caption{Match Fields}
\end{figure}
\clearpage
%
...
%
%
\subparagraph[Data Setup]{\Large Data Setup}
...
%
%
\subparagraph[Create Attachments]{\Large Create Attachments\texorpdfstring{\\}{}}

{\LARGE Right Click $\Rightarrow$ Manage $\Rightarrow$ Add Attachments}
\vspace{.3in}
