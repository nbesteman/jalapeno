...
{\LARGE\noindent\fbox{Settings}  $\Rightarrow$}
\vspace{3in}

{\LARGE\noindent\fbox{Photo Settings}  $\Rightarrow$}
  %
\clearpage
  %
  %%%%%%%%%%%%%%%%%%%%
...
{\LARGE\noindent\fbox{Camera Resolution}  $\Rightarrow$}
\vspace{6.5in}

{\LARGE\noindent\fbox{640 x 480}  $\Rightarrow$}
  %
\clearpage
  %
...
\begin{wrapfigure}{r}{0.5\textwidth}
\centering
    \includegraphics[width=.36\textwidth]{preprocess.png}
\vspace{-.1in}
...
\noindent\fbox{Open 1.Preprocess}
\clearpage
  %
  %
