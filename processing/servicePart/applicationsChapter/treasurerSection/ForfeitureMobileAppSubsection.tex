...
\noindent{\bigbtn\fbox{Windows Search} \lookArrow}
...
\centering
    \includegraphics[width=.4\textwidth]{reconcileToolSearch.PNG}
...
\centering
    \includegraphics[width=.4\textwidth]{ReconcileFieldVersionsInTool.PNG}
