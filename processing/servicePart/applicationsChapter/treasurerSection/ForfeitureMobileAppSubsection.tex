...
%\vspace{.3in}
 ...
 \item {Parcel year is = current year - 3}
 \item {I.E. Use ACParcelsCombHistoric2017 in 2020}
 \end{itemize}
 ...
 \begin{figure}[h!]
 \centering
     \includegraphics[width=.75\textwidth]{ParcelLayerAdded.PNG}
 ...
 \clearpage
  ...
  \paragraph{Check for any Forfeiture Parcel that will be missing spatial data}
%\vspace{.3in}
 ...
 \begin{figure}[h!]
 \centering
     \includegraphics[width=.75\textwidth]{joinToForfTable.PNG}
 ...
 \clearpage
   ...
   \paragraph{Select Any records that are missing spatial}
%\vspace{.3in}

 \begin{itemize}
 \item {Select and export Parcels missing spatial}
 ...
 \begin{figure}[h!]
 \centering
     \includegraphics[width=.5\textwidth]{selectForMissingSpatial.PNG}
 ...
 \begin{figure}[h!]
 \centering
     \includegraphics[width=.5\textwidth]{exportMissingSpatial.PNG}
