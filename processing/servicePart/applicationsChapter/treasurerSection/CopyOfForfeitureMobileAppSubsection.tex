...
\clearpage
 ...
 \noindent {\btn {Push }\fbox{the cloud button} \lookArrow}
  ...
  \noindent {\btn\fbox{Define Area of Interest} \lookArrow}
    %
  \vspace{1in}
  ...
  \noindent {\Large Choose Map Detail}
    %
  \vspace{.5in}
  
  \noindent {\btn\fbox{Push Choose Map Detail} \lookArrow}
  \vspace{.5in}
...
%  \clearpage
 ...
 {\bigbtn\fbox{Push Open}  \lookArrow} 
...
%
 ...
 %\centering
   \begin{figure}[h!]
     ...
     \includegraphics[width=.7\textwidth]{reconcileToolSearch.PNG}
