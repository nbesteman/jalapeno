...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  % Chapter Styles create the chapter title page style elements
  % (SPACING, GRAPHIC, AND TYPEFACE PROPERTIES)
    % beginning oF customchpstyle
...
\makechapterstyle{jalapenoChapterStyle}{%
    ...
    %\renewcommand*{\chapnumfont}{\chancery\slshape} % Number Font
