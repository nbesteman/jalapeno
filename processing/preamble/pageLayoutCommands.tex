...
%+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
%  SET HEAD STYLES
\setsecheadstyle{\Large\scshape\color{HeaderOrangeD}} % default is \Large\bfseries
    %\setsecheadstyle{\scshape\color{HeaderOrangeB}}
    %
    % Subsection
\setsubsecheadstyle{\large\scshape\color{HeaderOrangeC}} % default is \large\bfseries
...
%\setparaheadstyle{\bfseries\LARGE\color{HeaderBlueC}}%
%\setparaheadstyle{\ag\LARGE\color{HeaderBlueC}}%
\setparaheadstyle{\LARGE\color{HeaderBlueC}} % default is \bfseries
...
%\setsubparaheadstyle{\bfseries\Large\color{HeaderBlueA}}%
%\setsubparaheadstyle{\ag\Large\color{HeaderBlueA}}%
\setsubparaheadstyle{\Large\color{HeaderBlueA}} % default is \bfseries
%-------------------------------------------------------------------
  %
%+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  %  SET BEFORE SKIPS (Before the title)
...
\setbeforesubsubsecskip{-16pt plus -4pt minus -2pt}
%\setbeforeparaskip{-32.5pt plus -10pt minus -2pt}
\setbeforeparaskip{-16pt plus -4pt minus -2pt}
...
%-------------------------------------------------------------------
  %
%+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  %  SET AFTER SKIPS (BW the title and the text)
